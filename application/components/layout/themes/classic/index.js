...
const ClassicTheme = (props) => {
    ...
    const profileImage = profile && profile.url ? `${API_BASE_URL}${profile.url}` : "/static/themes/classic/images/photo.png";

    const coverImage = cover && cover.url ? `${API_BASE_URL}${cover.url}` : '';
